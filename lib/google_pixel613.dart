...
class GooglePixel613 extends StatelessWidget {
  GooglePixel613({
    Key? key,
  }) : super(key: key);
  @override
    ...
    return Scaffold(
      ...
      body: Stack(
        children: <Widget>[
          ...
          Pinned.fromPins(
            Pin(size: 109.0, end: 255.0),
            Pin(start: 55.8, end: 711.2),
            child: PageLink(
              links: [
                PageLinkInfo(
                  transition: LinkTransition.Fade,
...
const String _svg_yu3nf =
    '<svg viewBox="23.0 58.8 16.0 21.0" ><path transform="matrix(-1.0, 0.0, 0.0, -1.0, 38.97, 79.75)" d="M 0 18.64260101318359 L 10.64970016479492 10.50030040740967 L 0 2.358000040054321 L 2.265300035476685 0 L 16.00020027160645 10.50030040740967 L 2.265300035476685 20.99970054626465 L 0 18.64260101318359 Z" fill="#33bafe" stroke="none" stroke-width="1" stroke-miterlimit="10" stroke-linecap="butt" /></svg>';
